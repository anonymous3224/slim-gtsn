...
CHECKPOINT_DIR=$MY_PROJECT_HOME/tmp/cub200-models/prune/localtrain_lr0.2
...
learning_rate=0.001
TRAIN_DIR=$MY_PROJECT_HOME/tmp/cub200-models/prune/finetune_lr${learning_rate}

python p2_finetune_resnet_v1_50.py \
  --train_dir=${TRAIN_DIR} \
  --dataset_name=cub200 \
