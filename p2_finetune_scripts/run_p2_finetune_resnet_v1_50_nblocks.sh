...
block_size=2
CHECKPOINT_DIR=${MY_PROJECT_HOME}/tmp/cub200-models/prune/localtrain_lr0.3_bs${block_size}
...
learning_rate=0.001
TRAIN_DIR=$MY_PROJECT_HOME/tmp/cub200-models/prune_${COMPUTER_NAME}/exp5/finetune_lr${learning_rate}_bs${block_size}

python p2_finetune_resnet_v1_50_nblocks.py \
  --train_dir=${TRAIN_DIR} \
  --dataset_name=cub200 \
