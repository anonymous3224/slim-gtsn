...
CHECKPOINT_DIR=$MY_PROJECT_HOME/tmp/cub200-models/prune_inception_v2/localtrain_lr0.08
...
learning_rate=0.001
TRAIN_DIR=$MY_PROJECT_HOME/tmp/cub200-models/prune_inception_v2/finetune_lr${learning_rate}

python p2_finetune_inception_v2.py \
  --train_dir=${TRAIN_DIR} \
  --dataset_name=cub200 \
