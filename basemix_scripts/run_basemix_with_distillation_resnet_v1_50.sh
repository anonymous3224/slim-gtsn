...
TRAIN_DIR=$MY_PROJECT_HOME/tmp/cub200-models/prune/entropy_logits_lr${learning_rate}

# input variables
for start_config_id in 1
do 

python basemix_with_distillation_resnet_v1_50.py \
  --train_dir=${TRAIN_DIR} \
  --dataset_name=cub200 \
