...
from train_helper_for_resnet_v1_101 import * 
...
tf.app.flags.DEFINE_string(
    'model_name', 'resnet_v1_101', 'The name of the architecture to train.')
...
tf.app.flags.DEFINE_string(
    'net_name_scope_checkpoint', 'resnet_v1_101',
    'The name scope for the saved previous trained network')

tf.app.flags.DEFINE_string(
    'net_name_scope_pruned', 'resnet_v1_101_pruned',
...
tf.app.flags.DEFINE_integer(
    'test_batch_size', 100, 'The number of samples in each batch for the test dataset.')
