    ...
    with tf.Graph().as_default():
        ...
        for kept_percentage in kept_percentages:
            ...
            for i, block_name in enumerate(block_names):
                ...
                outputs = end_points[valid_block_name_to_end_points_key(block_name, net_name_scope_checkpoint)]
                outputs_pruned = end_points_pruned[valid_block_name_to_end_points_key(block_name, net_name_scope_pruned)]
                ...
                # Add train operation       #
                #############################
                variables_to_train = get_trainable_variables_with_block_names(net_name_scope_pruned, block_name)
                ...
                update_ops = get_update_ops_with_block_names(net_name_scope_pruned, block_name)
