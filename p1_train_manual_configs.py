...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        # Each pruned network contains totally 16 train operations. 
        ...
        for kept_percentage in kept_percentages:
            ...
            set_prune_units_inputs(prune_info, net_name_scope, end_points)
            ...
            #############################
            outputs_scopes = get_prune_units_outputs_scopes(prune_info, net_name_scope)
            outputs_scopes_pruned = get_prune_units_outputs_scopes(prune_info, net_name_scope_pruned)
            train_scopes = get_train_scopes_for_local_train(prune_info, net_name_scope_pruned) 
