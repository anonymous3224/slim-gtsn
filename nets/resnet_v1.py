...
def bottleneck(inputs,
  ...
  """
  if prune_unit:
    return bottleneck_pruned(inputs = inputs, 
                            depth = depth, 
...
# block.unit_fn(net, prune_layers=prune_layers, 
                                    # local_train=local_train, rate=1, **unit)
                                    # unit: stride, depth, depth_bottleneck
...
# func(images, num_classes, prune_info, is_training=is_training, local_train=local_train)
def resnet_v1_50_pruned(inputs,
                 num_classes=None,
                 prune_info=None,
                 is_training=True,
                 is_local_train=None,
                 ...
                 spatial_squeeze=True,
                 reuse=None,
                 scope='resnet_v1_50_pruned'):
  """ResNet-50 model of [1] with convolutional layers are pruned"""
  blocks = [
  ...
  return resnet_v1_pruned(inputs, blocks, num_classes, prune_info, is_training, is_local_train=is_local_train,
                   global_pool=global_pool, output_stride=output_stride,
                   include_root_block=True, spatial_squeeze=spatial_squeeze,
                   reuse=reuse, scope=scope)
resnet_v1_50_pruned.default_image_size = resnet_v1.default_image_size
...
def resnet_v1_101_pruned(inputs,
                  num_classes=None,
                  prune_info=None,
                  is_training=True,
                  is_local_train=None,
  ...
  return resnet_v1_pruned(inputs, blocks, num_classes, prune_info, is_training, is_local_train=is_local_train,
                   ...
                   include_root_block=True, spatial_squeeze=spatial_squeeze,
                   reuse=reuse, scope=scope)
resnet_v1_101_pruned.default_image_size = resnet_v1.default_image_size
